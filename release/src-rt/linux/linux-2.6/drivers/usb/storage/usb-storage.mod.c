...
MODULE_ALIAS("usb:v03EEp6901d0200dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v03EEp6901d0[0-1]*dc*dsc*dp*ic*isc*ip*in*");
...
MODULE_ALIAS("usb:v0421p0019d05[10-9]*dc*dsc*dp*ic*isc*ip*in*");
...
MODULE_ALIAS("usb:v0421p047Cd0370dc*dsc*dp*ic*isc*ip*in*");
...
MODULE_ALIAS("usb:v0424p0FDCd0210dc*dsc*dp*ic*isc*ip*in*");
...
MODULE_ALIAS("usb:v04CEp0002d026[12-9]dc*dsc*dp*ic*isc*ip*in*");
...
MODULE_ALIAS("usb:v057Bp0000d0[3-9]*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v057Bp0000d[1-9]*dc*dsc*dp*ic*isc*ip*in*");
...
MODULE_ALIAS("usb:v0781p5406d*dc*dsc*dp*ic*isc*ip*in*");
...
MODULE_ALIAS("usb:v12D1p*d*dc*dsc*dp*ic08isc06ip50in*");
