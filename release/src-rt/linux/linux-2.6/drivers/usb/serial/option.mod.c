...
MODULE_ALIAS("usb:v12D1p1001d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1003d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1004d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1401d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1402d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1403d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1404d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1405d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1406d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1407d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1408d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1409d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p140Ad*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p140Bd*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p140Cd*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p140Dd*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p140Ed*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p140Fd*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1410d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1411d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1412d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1413d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1414d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1415d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1416d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1417d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1418d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1419d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p141Ad*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p141Bd*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p141Cd*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p141Dd*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p141Ed*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p141Fd*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1420d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1421d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1422d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1423d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1424d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1425d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1426d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1427d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1428d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1429d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p142Ad*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p142Bd*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p142Cd*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p142Dd*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p142Ed*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p142Fd*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1430d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1431d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1432d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1433d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1434d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1435d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1436d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1437d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1438d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1439d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p143Ad*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p143Bd*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p143Cd*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p143Dd*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p143Ed*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p143Fd*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1464d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1465d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v12D1p1803d*dc*dsc*dp*icFFiscFFipFFin*");
...
MODULE_ALIAS("usb:v413Cp8147d*dc*dsc*dp*ic*isc*ip*in*");
...
MODULE_ALIAS("usb:v1A8Dp1002d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1A8Dp1003d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1A8Dp1004d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1A8Dp1005d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1A8Dp1006d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1A8Dp1007d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1A8Dp1008d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1A8Dp1009d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1A8Dp100Ad*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1A8Dp100Bd*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1A8Dp100Cd*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1A8Dp100Dd*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1A8Dp100Ed*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1A8Dp100Fd*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1A8Dp1010d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1A8Dp1011d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1A8Dp1012d*dc*dsc*dp*ic*isc*ip*in*");
...
MODULE_ALIAS("usb:v19D2p0007d*dc*dsc*dp*icFFiscFFipFFin*");
...
MODULE_ALIAS("usb:v19D2p0146d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v19D2p0147d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v19D2p0148d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v19D2p0149d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v19D2p0150d*dc*dsc*dp*icFFiscFFipFFin*");
...
MODULE_ALIAS("usb:v19D2p0154d*dc*dsc*dp*icFFiscFFipFFin*");
...
MODULE_ALIAS("usb:v19D2p0160d*dc*dsc*dp*icFFiscFFipFFin*");
...
MODULE_ALIAS("usb:v19D2pFFF5d*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v19D2pFFFFd*dc*dsc*dp*icFFiscFFipFFin*");
MODULE_ALIAS("usb:v1D6Bp0002d*dc*dsc*dp*ic*isc*ip*in*");
...
MODULE_ALIAS("usb:v0BDBp1900d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v0BDBp1902d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1266p1002d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1266p1003d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1266p1004d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1266p1005d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1266p1006d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1266p1007d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1266p1008d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1266p1009d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1266p100Ad*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1266p100Bd*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1266p100Cd*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1266p100Dd*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1266p100Ed*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1266p100Fd*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1266p1011d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1266p1012d*dc*dsc*dp*ic*isc*ip*in*");
...
MODULE_ALIAS("usb:v1EE8p000Bd*dc*dsc*dp*ic*isc*ip*in*");

MODULE_INFO(srcversion, "EE3A526F33FE18173BFD7F3");
