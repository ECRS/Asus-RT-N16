...
if (E('_vpn_client1_custom').value.length)
document.getElementById('_vpn_client1_custom').value = stripShellComments(E('_vpn_client1_custom').value);
if (E('_vpn_client1_ca').value.length)
document.getElementById('_vpn_client1_ca').value = stripShellComments(E('_vpn_client1_ca').value);
if (E('_vpn_client1_crt').value.length)
document.getElementById('_vpn_client1_crt').value = stripShellComments(E('_vpn_client1_crt').value);
