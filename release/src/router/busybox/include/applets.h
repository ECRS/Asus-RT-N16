...
IF_MKE2FS(APPLET(mke2fs, BB_DIR_SBIN, BB_SUID_DROP))
...
IF_MKE2FS(APPLET(tune2fs, BB_DIR_SBIN, BB_SUID_DROP))
IF_E2LABEL(APPLET_ODDNAME(e2label, tune2fs, BB_DIR_SBIN, BB_SUID_DROP, tune2fs))
...
IF_UDHCPC_OLD(APPLET(udhcpc, BB_DIR_SBIN, BB_SUID_DROP))
