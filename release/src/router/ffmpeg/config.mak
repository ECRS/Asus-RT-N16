...
SRC_PATH="/home/astclair/AsusRT-N16/trunk/tomato/release/src/router/ffmpeg"
SRC_PATH_BARE=/home/astclair/AsusRT-N16/trunk/tomato/release/src/router/ffmpeg
BUILD_ROOT="/home/astclair/AsusRT-N16/trunk/tomato/release/src/router/ffmpeg"
ARCH=mips
CC=mipsel-uclibc-gcc
AS=mipsel-uclibc-gcc
LD=mipsel-uclibc-gcc
DEPCC=mipsel-uclibc-gcc
YASM=yasm
YASMDEP=yasm
AR=mipsel-uclibc-ar
...
CFLAGS= -Os -DLINUX26 -DCONFIG_BCMWL5 -pipe -DBCMWPA2 -funit-at-a-time -Wno-pointer-sign -mtune=mips32 -mips32 -ffunction-sections -fdata-sections -fPIC -I/home/astclair/AsusRT-N16/trunk/tomato/release/src-rt/router/zlib  -std=c99 -fomit-frame-pointer -fPIC -pthread -Wdeclaration-after-statement -Wall -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wundef -Wmissing-prototypes -Os -fno-math-errno -fno-tree-vectorize -Werror=implicit -Werror=missing-prototypes
ASFLAGS= -Os -DLINUX26 -DCONFIG_BCMWL5 -pipe -DBCMWPA2 -funit-at-a-time -Wno-pointer-sign -mtune=mips32 -mips32 -ffunction-sections -fdata-sections -fPIC -I/home/astclair/AsusRT-N16/trunk/tomato/release/src-rt/router/zlib  -fPIC
CC_O=-o $@
LDFLAGS=  -ffunction-sections -fdata-sections -Wl,--gc-sections -fPIC -Wl,--warn-common -Wl,--as-needed -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavutil -Wl,-Bsymbolic
...
EXTRALIBS= -L/home/astclair/AsusRT-N16/trunk/tomato/release/src-rt/router/zlib -lz  -lz -pthread -lm
INSTALL=install
LIBTARGET=
