...
var m = [
    ...
    { title: 'Remote Access', rid: 'remote_access', name: 'f_http_remote', type: 'select', options: [[0,'Disabled'],[1,'HTTP'],[2,'HTTPS']],
        value:  (nvram.remote_management == 1) ? ((nvram.remote_mgt_https == 1) ? 2 : 1) : 0 },
    { title: 'Port', rid: 'remote_access_port', indent: 2, name: 'http_wanport', type: 'text', maxlen: 5, size: 7, value:  fixPort(nvram.http_wanport, 8080) },
    { title: 'Allow Wireless Access', name: 'f_http_wireless', type: 'checkbox', value:  nvram.web_wl_filter == 0 },
    { title: '', rid: 'hr' },
    { title: 'Directory with GUI files', rid: 'gui_directory', name: 'web_dir', type: 'select',
    ...
    { title: 'Color Scheme', rid: 'color_scheme', name: 'web_css', type: 'select',
        options: [['ecrstomato','ECRS'],['openlinksys','USB Blue - OpenLinksys'],['red','Tomato'],['ext/custom','Custom (ext/custom.css)'], ['online', 'On-line from TTB']], value: nvram.web_css },
...
createFieldTable('', [
    ...
    { title: 'Remote Access', rid: 'ssh_remote_access', name: 'f_sshd_remote', type: 'checkbox', value: nvram.sshd_remote == 1 },
    { title: 'Remote Port', rid: 'ssh_remote_port', indent: 2, name: 'sshd_rport', type: 'text', maxlen: 5, size: 7, value: nvram.sshd_rport },
...
<div class='section-title hidden'>Telnet Daemon</div>
...
createFieldTable('', [
    ...
    { title: 'Limit Connection Attempts', rid: 'f_original_limit', multi: [
    ...
    { title: 'Limit SSH Connection Attempts', indent: 2, multi: [
